...
function _buildMedNumAssessmentParticipations({ databaseBuilder }) {
  ...
  participateToAssessmentCampaign({ databaseBuilder, campaignId: 11, user: anonymousUser, organizationLearnerId: anonymousSchoolingRegistration.id, status: SHARED });
}
